...
# Q) 2:- Create a class 'Pets' form a class 'Animals' and further create a class 'Dog' from 'Pets'. Add a methid 'bark' to class 'Dog'.
class Animals:
    pass
...
# Q) 4:- Write a class 'Complex' to represent complex numbers, along with over loaded operators '+' and '*' which adds and multiplies them.
class Complex:
...
# Q) 5:- Write a class vector representing a vector of n dimensions. Overload the + and * operator which calculates the sum and the dot(.) product of them.
class Vector:
